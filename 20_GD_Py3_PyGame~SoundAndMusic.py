...
'''
    Pygame tutorial video 20
    Title: Sound And Music
    URL: https://www.youtube.com/watch?v=RipQndiUDfQ&index=20&list=PLQVvvaa0QuDdLkP8MrOXLe_rKuf6r80KO
'''
...
#music from
#https://soundcloud.com/dave-allison/dave-allison-blue-jazz
pygame.mixer.music.load("Dave_Allison-Blue_Jazz(Kinjo_001).wav")
